...
return cljs.core.merge.call(null,initial_state,p1__24554_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_24555 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_24556 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_24555);
var pos_24557 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_24555);
quil.core.scale.call(null,zoom_24556);

var tr__24478__auto___24558 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_24556) - cljs.core.first.call(null,pos_24557)),(((quil.core.height.call(null) / (2)) / zoom_24556) - cljs.core.second.call(null,pos_24557))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__24478__auto___24558);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1456984143834