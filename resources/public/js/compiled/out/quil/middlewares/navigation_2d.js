...
return cljs.core.merge.call(null,initial_state,p1__26312_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_26313 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_26314 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_26313);
var pos_26315 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_26313);
quil.core.scale.call(null,zoom_26314);

var tr__26236__auto___26316 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_26314) - cljs.core.first.call(null,pos_26315)),(((quil.core.height.call(null) / (2)) / zoom_26314) - cljs.core.second.call(null,pos_26315))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__26236__auto___26316);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1457675247854